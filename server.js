...
connection.connect((error) => {
  ...
  console.log(``);
  console.log(chalk.whiteBright.bold(figlet.textSync('Employee Tracker')));
  console.log(``);
  console.log(``);
  console.log(chalk.white.bold(`====================================================================================`));
  promptUser();
...
const viewAllEmployees = () => {
  ...
  connection.query(sql, (error, response) => {
    if (error) throw error;
    console.log(chalk.white.bold(`====================================================================================`));
    console.log(`                              ` + chalk.white.bold(`Current Employees:`));
    console.log(chalk.white.bold(`====================================================================================`));
...
const viewAllRoles = () => {
  console.log(chalk.white.bold(`====================================================================================`));
  console.log(`                              ` + chalk.white.bold(`Current Employee Roles:`));
  console.log(chalk.white.bold(`====================================================================================`));
...
const viewDepartmentBudget = () => {
  console.log(chalk.white.bold(`====================================================================================`));
  console.log(`                              ` + chalk.white.bold(`Budget By Department:`));
  console.log(chalk.white.bold(`====================================================================================`));
    ...
    inquirer
      ...
      .then((answer) => {
        ...
        connection.query(sql, answer.newDepartment, (error, response) => {
          if (error) throw error;
          console.log(``);
          console.log(chalk.whiteBright(answer.newDepartment + ` Department successfully created!`));
          console.log(``);
          viewAllDepartments();
        });
      });
          ...
          .then((answer) => {
            ...
            connection.query(
              ...
              (error) => {
                ...
                console.log(chalk.whiteBright(`Employee Role Updated`));
                console.log(chalk.whiteBright.bold(`====================================================================================`));
                promptUser();
              }
            );
      ...
      inquirer
        ...
        .then((answer) => {
          ...
          if (validate.isSame(answer.chosenEmployee, answer.newManager)) {
            console.log(chalk.whiteBright.bold(`====================================================================================`));
            console.log(chalk.whiteBright(`Invalid Manager Selection`));
            console.log(chalk.whiteBright.bold(`====================================================================================`));
            promptUser();
          } else {
            ...
            connection.query(
              ...
              (error) => {
                if (error) throw error;
                console.log(chalk.whiteBright.bold(`====================================================================================`));
                console.log(chalk.whiteBright(`Employee Manager Updated`));
                console.log(chalk.whiteBright.bold(`====================================================================================`));
                promptUser();
              }
            );
      ...
      inquirer
        ...
        .then((answer) => {
          ...
          connection.query(sql, [employeeId], (error) => {
            if (error) throw error;
            console.log(chalk.whiteBright.bold(`====================================================================================`));
            console.log(chalk.whiteBright(`Employee Successfully Removed`));
            console.log(chalk.whiteBright.bold(`====================================================================================`));
            viewAllEmployees();
          });
        });
      ...
      inquirer
        ...
        .then((answer) => {
          ...
          connection.query(sql, [roleId], (error) => {
            if (error) throw error;
            console.log(chalk.whiteBright.bold(`====================================================================================`));
            console.log(chalk.whiteBright(`Role Successfully Removed`));
            console.log(chalk.whiteBright.bold(`====================================================================================`));
            viewAllRoles();
          });
        });
      ...
      inquirer
        ...
        .then((answer) => {
          ...
          connection.query(sql, [departmentId], (error) => {
            if (error) throw error;
            console.log(chalk.whiteBright.bold(`====================================================================================`));
            console.log(chalk.whiteBright(`Department Successfully Removed`));
            console.log(chalk.whiteBright.bold(`====================================================================================`));
            viewAllDepartments();
          });
        });
